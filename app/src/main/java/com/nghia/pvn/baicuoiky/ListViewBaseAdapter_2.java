...
public abstract class ListViewBaseAdapter_2 extends BaseAdapter {
    public ArrayList<com.nghia.pvn.baicuoiky.ListViewBean_2> arrayListListener;
    private List<com.nghia.pvn.baicuoiky.ListViewBean_2> mListenerList;
    Context mContext;

    public ListViewBaseAdapter_2(ArrayList<ListViewBean_2> mListenerList, Context context){
        mContext = context;
        this.mListenerList = mListenerList;
        this.arrayListListener = new ArrayList<com.nghia.pvn.baicuoiky.ListViewBean_2>();
