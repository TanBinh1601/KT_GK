...
public abstract class ListViewBaseAdapter extends BaseAdapter {
    public ArrayList<com.nghia.pvn.baicuoiky.ListViewBean> arrayListListener;
    private List<com.nghia.pvn.baicuoiky.ListViewBean> mListenerList;
    Context mContext;

    public ListViewBaseAdapter(ArrayList<ListViewBean> mListenerList, Context context){
        mContext = context;
        this.mListenerList = mListenerList;
        this.arrayListListener = new ArrayList<com.nghia.pvn.baicuoiky.ListViewBean>();
